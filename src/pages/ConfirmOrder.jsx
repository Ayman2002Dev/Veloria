  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 3 }}>
        ...
        >
          ...
          <Typography component="p" variant="subtitle2">
            ...
            <Typography
              ...
              sx={{ ml: 0.5, fontWeight: "600" }}
            >
              {`${new Date(lastOrder.createdAt).toLocaleDateString()}  ${new Date(lastOrder.createdAt).toLocaleTimeString()}` ||
                "date"}
            </Typography>
          </Typography>
        </Box>
      ...
      <Paper component="section" elevation={0} sx={{ mt: 5 }}>
        ...
        <Button
          variant="contained"
          disabled={lastOrder?.status === "complete"}
          sx={{
